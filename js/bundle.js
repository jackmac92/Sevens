...
/***/ function(module, exports, __webpack_require__) {
	...
	Game = (function() {
	  ...
	  Game.prototype.gameFinished = function() {
	    var currTile, i, j, k, len, len1, len2, ref, ref1, row, spot, tile;
	    ref = this.board.grid;
	    for (i = 0, len = ref.length; i < len; i++) {
	      ...
	      for (j = 0, len1 = row.length; j < len1; j++) {
	        ...
	        if (spot === null) {
	          ...
	          currTile = spot;
	          ref1 = this.board.surroundingTiles(currTile.pos);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Board = (function() {
	  ...
	  Board.prototype.deltaTilePattern = function(dir) {
	    switch (dir) {
	      case "N":
	        return this.tilesByRow();
	      case "E":
	        return this.tilesByColumn().reverse();
	      case "W":
	        return this.tilesByColumn();
	      case "S":
	        return this.tilesByRow().reverse();
	    }
	  };
	  ...
	  Board.prototype.spotAvailable = function(pos) {
	    return this.isValidPosition(pos) && this.isEmptyPosition(pos);
	  };
	  ...
	  Board.prototype.setTileAt = function(pos, val) {
	  ...
	  Board.prototype.isEmptyPosition = function(pos) {
	    return this.tileAt(pos) === null;
	  };
	
	  Board.prototype.moveTileTo = function(tile, dest) {
	    this.setTileAt(tile.pos, null);
	    this.setTileAt(dest, tile);
	    return tile.moveTo(dest);
	  };
	
	  Board.prototype.mergeTiles = function(sourceTile, receivingTile) {
	    this.grid[sourceTile.pos[1]][sourceTile.pos[0]] = null;
	  ...
	  Board.prototype.entryPositions = {
	    "N": ["*", 3],
	    "E": [0, "*"],
	    "W": [3, "*"],
	    "S": ["*", 0]
...
/***/ function(module, exports) {
	...
	Tile = (function() {
	  ...
	  Tile.prototype.canMergeWith = function(val) {
	    if (val < 5) {
	      return val + this.value === 7;
	    } else {
	      return val === this.value;
	    }
	  };
	
	  Tile.prototype.renderIdx = function() {
	    return this.pos[1] * 4 + this.pos[0];
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	GameView = (function() {
	  function GameView(game, gameRoot) {
	    this.game = game;
	  ...
	  GameView.prototype.bindKeys = function() {
	    ...
	    return Mousetrap.bind(["a", "left"], function() {
	      return self.makeMove("W");
	    });
	  };
